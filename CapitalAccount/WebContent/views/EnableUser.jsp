	...
	<div class="search" >
		<form id="searchForm">
			<div style="margin-left: auto;margin-right: auto;">
				...
				<a href="javascript:void(0)" id="searchEnableBtn" class="easyui-linkbutton" data-options="iconCls:'icon-search'">查询</a>
				<a href="javascript:void(0)" id="frozenBtn" class="easyui-linkbutton" data-options="iconCls:'icon-delete'">冻结</a>
			</div>
		</form>
	</div>
	<div>
		<table id="allUser" class="easyui-datagrid" style="width:100%;height:250px" url="adminServlet?cmd=queryEnableUser">
